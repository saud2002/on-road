...
<body style="margin: 0; font-family: Arial, sans-serif; background-color: #f5f8fa;">

    <!-- Header -->
    <header style="background-color: #007bff; color: white; text-align: center; padding: 40px 20px;">
        <h1 style="margin: 0; font-size: 36px;">🏢 Available Garages</h1>
        <p style="font-size: 18px; margin-top: 10px;">Find trusted garages near you</p>
    </header>

    <!-- Garage Cards Container -->
    <div style="max-width: 1100px; margin: 40px auto; display: flex; flex-wrap: wrap; gap: 20px; justify-content: center; padding: 0 20px;">
       ...
       <div style="width: 300px; background-color: white; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); overflow: hidden; display: flex; flex-direction: column;">
        ...
        <div style="width: 300px; background-color: white; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); overflow: hidden; display: flex; flex-direction: column;">
            ...
            <div style="padding: 20px; flex-grow: 1;">
                <h2 style="margin-top: 0; color: #fd7e14;">MaxWheels Garage</h2>
                <p><strong>Location:</strong> Sector 21, Near Mall, City</p>
                <p><strong>Contact:</strong> +91 9988776655</p>
                <p><strong>Services:</strong> Oil Change, Brakes, Suspension</p>
            </div>
    ...
    <!-- Footer -->
    <footer style="text-align: center; background-color: #343a40; color: white; padding: 20px;">
